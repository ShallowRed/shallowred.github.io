import{i as e}from"./preload-helper-DaCzexP6.js";import{u as t}from"./iframe-BBC5HgxN.js";import{C as n,H as r,Y as i,_ as a,ht as o,yt as s}from"./ri-CwakkzoF.js";import{i as c,n as l,t as u}from"./badge-etiquette-CIoDaKP1.js";import{n as d,t as f}from"./thematique-scope-BHXNpb8q.js";import{n as p,t as m}from"./carte-contenu-DGUhtqaL.js";var h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I;e((()=>{h=t(),s(),d(),c(),p(),g={title:`Candidats/Partagé/Briques/Carte de contenu`,component:m,tags:[`autodocs`],parameters:{docs:{description:{component:[`Carte de contenu versatile, partagée entre la vitrine et l’espace`,`membre. C’est l’**instanciation** (slots et libellés) qui définit`,`l’usage : événement, actualité, ressource, amorce, carte de thématique…`,``,`Le détail des props est dans la table de contrôles ci-dessous ; chaque`,"story illustre un registre. À retenir : `categorie` → **Etiquette**","(pill, éditorial), `etat` → **Badge** (carré, système), `meta` → donnée","neutre en gris ; la teinte thématique vient d’un `ThematiqueScope`",`parent (cf. story dédiée).`].join(`
