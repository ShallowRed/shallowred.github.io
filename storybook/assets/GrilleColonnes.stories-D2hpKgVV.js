import{i as e}from"./preload-helper-DaCzexP6.js";import{u as t}from"./iframe-BeshMaXC.js";import{n,t as r}from"./grille-colonnes-DE5rQJiV.js";import{n as i,t as a}from"./section-vitrine-C4L8fAEi.js";var o,s,c,l,u,d,f,p;e((()=>{o=t(),n(),i(),s={title:`Candidats/Vitrine/Socle/Briques/Grille colonnes`,component:r,tags:[`autodocs`,`!manifest`],parameters:{espace:`vitrine`,layout:`fullscreen`,docs:{description:{component:[`Grille N colonnes desktop / 1 colonne mobile, en CSS grid pur.`,"Remplace mécaniquement le couple `fr-grid-row` + `fr-col-md-*` dans",`les sections éditoriales.`].join(`
